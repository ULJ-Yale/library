...
#For Xnat testing
mkdir ${SESSIONS_FOLDER}/specs/xnat
curl -k -u ${XNAT_USER_NAME}:${XNAT_PASSWORD} -X GET "${XNAT_HOST_NAME}/data/archive/projects/${XNAT_PROJECT}/resources/BASH_SCRIPTS/files?format=zip" > ${SESSIONS_FOLDER}/specs/xnat/BASH_SCRIPTS.zip
cd ${SESSIONS_FOLDER}/specs/xnat
