...
if [ -z "${FSL_FIX_MATLAB_ROOT}" ]; then
       ...
       FSL_FIX_MATLAB_ROOT=${MATLABROOT}
fi
# On OS X this will most likely be something like /Applications/MATLAB_R20XX.app
...
FSL_FIX_MCC=${FSL_FIX_MATLAB_ROOT}/bin/glnxa64
...
FSL_FIX_CIFTIRW="${FIXDIR_DEPEND}/CIFTIMatlabReaderWriter"
...
echo "$0: FSL_FIX_WBC: ${FSL_FIX_WBC}"
